$(function()
{
	if ($('.tabbable').length)
	{
		...
		AWS.load_list_view(G_BASE_URL + '/explore/ajax/list/sort_type-new__recommend-1__topic_id-' + CONTENTS_RELATED_TOPIC_IDS, $('#c_recommend_more'), $('#c_recommend_list'), 2, function(){check_related_topic($('#c_recommend_list .aw-item'))});
