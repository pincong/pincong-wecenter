var AW_TEMPLATE = {
	...
	'searchDropdownListTopics' : 
		'<li class="topic clearfix"><a href="{{url}}" class="aw-topic-name" data-id="{{topic_id}}"><span>{{name}}</span></a> <span class="pull-right aw-small-text">{{discuss_count}} ' + _t('个讨论') + '</span></li>',
